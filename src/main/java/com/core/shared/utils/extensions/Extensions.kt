...
fun String.isValidPhoneNumber(countryCode: String = "0"): Boolean {
    ...
    val regexSau2 = Regex("^(96650|96653|96654|96655|96656|96657|96658|96659)\\d{7}")
    ...
    when (countryCode) {
        ...
        "0" -> isValidNumber =
            regexEg.matches(this) || regexIraq.matches(this) || regexSau.matches(this) || regexSau2.matches(this)
    }
    return isValidNumber
}

fun String.returnValidPhoneNumberWithCode():String{
    return this.replaceFirst("^0".toRegex(), "966")
}

fun Context.copyText(textValue: String) {
    showToast("${getString(R.string.copiedToClipboard)} $textValue")
    val clipboard = getSystemService(Context.CLIPBOARD_SERVICE) as ClipboardManager
    // Copy the text to the clipboard using ClipData
    val clip = ClipData.newPlainText("Copied Text", textValue)
...
fun Context.formatNumber(@StringRes res: Int, value1: Any?, value2: Any?) =
    String.format(Locale.ENGLISH, getString(res), value1, value2)
