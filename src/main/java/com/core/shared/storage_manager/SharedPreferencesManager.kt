...
class SharedPreferencesManager(context: Context) : StorageManager {
    ...
    private val sharedPref = context.getSharedPreferences(
        SharedPreferenceKey.SHARED_PREFERENCES_NAME, Context.MODE_PRIVATE
    )
    ...
    override fun setInteger(key: String, value: Int) = sharedPref.edit().putInt(key, value).apply()

    override fun getInteger(key: String, defaultValue: Int) = sharedPref.getInt(key, defaultValue)

    override fun setFloat(key: String, value: Float) =
        sharedPref.edit().putFloat(key, value).apply()

    override fun getFloat(key: String, defaultValue: Float) = sharedPref.getFloat(key, defaultValue)
