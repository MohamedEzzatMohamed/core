...
abstract class BaseActivity<dataBinding : ViewDataBinding, _navHostResourceId : Int?> :
    AppCompatActivity(), NetworkAwareComponent, SmartZoneErrorHandler, KoinComponent {
    ...
    val connectivityManager: ConnectivityManager by inject { parametersOf(this@BaseActivity) }
