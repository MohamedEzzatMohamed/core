...
public class LoadStateItemBindingImpl extends LoadStateItemBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.retryTitleTv, 2);
        sViewsWithIds.put(R.id.retryBtn, 3);
    }
    // views
    @NonNull
    ...
    public LoadStateItemBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 4, sIncludes, sViewsWithIds));
    }
    private LoadStateItemBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
